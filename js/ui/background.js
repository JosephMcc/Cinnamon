...
BackgroundCache.prototype = {
    ...
    getPatternContent: function(params) {
        ...
        for (let i = 0; i < this._patterns.length; i++) {
            ...
            if (params.shadingType != CDesktopEnums.BackgroundShading.SOLID &&
    ...
    getImageContent: function(params) {
        ...
        for (let i = 0; i < this._images.length; i++) {
            ...
            if (params.style == CDesktopEnums.BackgroundStyle.SPANNED &&
...
Background.prototype = {
    ...
    _load: function () {
        ...
        if (this._style == CDesktopEnums.BackgroundStyle.NONE) {
            this._setLoaded();
            return;
        }
...
SystemBackground.prototype = {
    _init: function() {
        ...
        this._cache.getImageContent({ style: CDesktopEnums.BackgroundStyle.WALLPAPER,
                                      filename: global.datadir + '/theme/blue.png',
                                      effects: Meta.BackgroundEffects.NONE,
                                      onFinished: Lang.bind(this, function(content) {
